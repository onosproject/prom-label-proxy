...
var (
	...
	plproxyConfigAddr   = flag.String("onos_config_url", "", "If specified, pull initial state from aether-config at this address")
	plproxyConfigTarget = flag.String("plproxy_config_target", "connectivity-service-v2", "Target to use when pulling from aether-config")
	//	modelVersion       = flag.String("model_version", "v1", "Version of modeling to use")
