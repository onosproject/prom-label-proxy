...
require (
	...
	github.com/google/gnxi v0.0.0-20210923102645-e736cefe28a7
	github.com/onosproject/config-models/modelplugin/plproxy-1.0.0 v0.0.0-20211012093932-c4e9ca23ea91
	...
	github.com/openconfig/ygot v0.12.2
